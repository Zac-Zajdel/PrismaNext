  ...
  return (
    <div className="px-0 py-20 flex flex-1 flex-col justify-center items-center">
      <div className="w-full max-w-md space-y-8">
            ...
            <div className="-space-y-px rounded-md shadow-sm">
              <div className="pb-4">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="relative block w-full appearance-none rounded-md border border-gray-300 px-3 mt-1 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                />
              </div>
              <div>
        ...
        <div>This would be the Github and Google Integration</div>
      </div>
    </div>
  )
}
